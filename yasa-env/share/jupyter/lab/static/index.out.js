...
export async function main() {
  ...
  if (!queuedFederated.includes('@lckr/jupyterlab_variableinspector')) {
    try {
      let ext = require('@lckr/jupyterlab_variableinspector');
      ext.__scope__ = '@lckr/jupyterlab_variableinspector';
      for (let plugin of activePlugins(ext)) {
        register.push(plugin);
      }
    } catch (e) {
